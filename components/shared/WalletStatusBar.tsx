...
export default function WalletStatusBar() {
  ...
  return (
    <div className="sticky top-0 z-40 w-full h-14 bg-[#020617]/80 backdrop-blur-md border-b border-emerald-500/20 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black uppercase tracking-widest text-white leading-none mb-1">
              FlowDAO Network Active
            </span>
            <span className="font-mono text-[11px] text-emerald-400 font-bold leading-none">
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-center">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-emerald-400 uppercase tracking-tighter">XLM</span>
                <button 
                  onClick={fetchWalletData}
                  disabled={loading}
                  className={cn(
                    "text-muted-foreground hover:text-emerald-400 transition-colors ml-1",
             ...
             <p className="text-[8px] font-bold text-muted-foreground/50 uppercase tracking-[0.2em] mt-1 italic">Stellar Protocol Testnet</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0">
           <Dialog>
            <DialogTrigger asChild>
              <Button size="sm" className="bg-emerald-600 hover:bg-emerald-500 text-white h-9 px-4 font-black uppercase tracking-widest text-[10px] italic shadow-lg shadow-emerald-500/20 border-b-2 border-emerald-700">
